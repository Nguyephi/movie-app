...
Learning to use multipe api for various reasons. One being to use it with the search input and button. learned a different way to put in pics, but this method is used for few pics. concating the previous page with more results.
